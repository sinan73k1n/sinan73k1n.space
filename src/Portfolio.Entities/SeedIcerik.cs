...
public static class SeedIcerik
{
    ...
    public static SiteContent Olustur() => new()
    {
        ...
        Demos = new()
        {
            ...
            new()
            {
                Path = "demo/NutritionTracker",
                Name = "Nutrition Tracker",
                Tags = new() { "HTML", "JS", "Calculator" },
                Html = "",
                Desc = new() { Tr = "Kalori/makro hesabı, ürün-yemek kütüphanesi ve kilo eğilimi olan beslenme takip demosu.", En = "Nutrition tracking demo with a calorie/macro calculator, food library and weight trend.", Ru = "Демо трекера питания: расчёт калорий и макросов, база продуктов и динамика веса." },
            },
            new()
            {
