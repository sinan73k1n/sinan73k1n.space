    ...
    public static SiteContent Olustur() => new()
    {
        ...
        I18n = new()
        {
            ["tr"] = new()
            {
                ...
                ["demosHint"] = "önizleme canlı çalışıyor — tıklanabilir hâli tam ekranda",
            ...
            ["en"] = new()
            {
                ...
                ["demosHint"] = "the preview is live — open full screen to interact with it",
            ...
            ["ru"] = new()
            {
                ...
                ["demosHint"] = "предпросмотр работает — откройте на весь экран, чтобы взаимодействовать",
